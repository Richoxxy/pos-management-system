...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       Mail::to('recipient@example.com')->send(new UserRegistered($user));

       return redirect()->route('users.index')->with('alertMessage', "User {$data['fullname']} added successfully");
    }
    ...
    public function destroy(User $user)
    {
        $user->delete();
         ...
         return redirect()->route('users.index')->with('alertMessage', "User {$user->name} deleted successfully");
    }
